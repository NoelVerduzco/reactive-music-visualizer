...
public class TemplateJdbcTemplateRepository implements TemplateRepository {
    ...
    public boolean update(Template template) {
        ...
        return jdbcTemplate.update(sql, template.getTemplateName(), template.getCanvasColor(), template.getDataRate(), template.getIsActive(), template.getTemplateId()) > 0;
    }
    ...
    private Shape addShapes(Shape shape, int templateId) {
        ...
        shape.setTemplateId(templateId);
    ...
    private Effect addEffects(Effect effect, int shapeId) {
        ...
        int rowsAffected = jdbcTemplate.update(connection -> {
            ...
            ps.setBoolean(2, effect.getIsEnabled());
            ps.setFloat(3, effect.getEffectValue());
            ps.setBoolean(4, effect.getIsRightChannel());
